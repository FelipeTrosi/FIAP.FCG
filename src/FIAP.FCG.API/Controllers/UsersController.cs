...
namespace FIAP.FCG.API.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class UserController(IBaseLogger<UserController> logger, IGameService service) : ControllerBase
    {
        private readonly IBaseLogger<UserController> _logger = logger;
